        ...
        <div className="mt-20">
          <FadeUp>
            ...
            <p className="text-text-muted text-center max-w-2xl mx-auto mb-10 text-sm">
              Apache NiFi ships with hundreds of production-ready processors for data acquisition, transformation, and routing — purpose-built for turning legacy and siloed data into AI-ready pipelines.
            </p>
          </FadeUp>
